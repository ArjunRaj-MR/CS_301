/*
Advantages of Circle linked list:
	travelling from the last node to the first node is faster and more easier.
	Easy to insert and delete nodes
	More efficient in using memory than arrays.
Disadvantages of circle linked list:
...
Changes in the program:
	...
	while traversing the loop condition should check for equality with the first node address, instead on 'NULL'.
...
int main()
{
	...
	printf("Creating the Circle linked list.....\n");
	for(i=0;i<10;i++)
	{
		if(i==0)
		{
